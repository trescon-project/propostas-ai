            ...
            <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-2 font-bold text-xl tracking-tighter text-white">
                        <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center text-white text-lg shadow-lg shadow-indigo-500/20">P</div>
                        <span>Propostas<span className="text-zinc-500 font-normal">.ai</span></span>
                    </div>
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <Link
                                    ...
                                    `}
                                >
                                    <Icon sx={{ fontSize: 20 }} className={isActive ? 'text-indigo-400' : ''} />
                                    {item.label}
                                </Link>
                            )
                        })}
